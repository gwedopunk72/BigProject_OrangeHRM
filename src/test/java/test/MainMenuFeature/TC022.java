...
public class TC022 extends TC00 {

    /**
     * [TC022] Dashboard check leave list
     */

    @Test
    public void DashboardCheckLeaveList() throws InterruptedException {

        dashboard.clickMenuDashboard();
        dashboard.clickMenuLeaveList();
        ...
        Thread.sleep(1000);
        dashboard.inputEmployeeField("Karyawan Teladan");
        dashboard.selectRadioPastEmploye();
